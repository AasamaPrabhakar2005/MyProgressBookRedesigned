	<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<style type="text/css">
			...
			#header-inner { margin:0 auto; padding:10px; width:1345px;background:#fff;}
			
			/* Feature */
			.feature { background:#eee;padding:0;}
			.feature-inner { margin:auto;padding:10px;width:1345px;background:orange; }
			...
			/* Content */
			#content-inner { margin:0 auto; padding:10px; width:1345px;background:#fff;}
			#content #contentbar { margin:0; padding:0; float:left; width:760px;}
			#content #contentbar  { margin:0 0 24px; padding:0 20px 0 15px;}
			#content #sidebar { padding:0; float:left; width:200px;}
			#content #sidebar .widget { margin:0 0 12px; padding:8px 8px 8px 8px;line-height:1.4em;}
			...
			#footer-inner { margin:auto; text-align:center; padding:12px; width:1345px;}
